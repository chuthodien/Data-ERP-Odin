...
WITH source AS (
    ...
    SELECT
        ...
        _airbyte_data::json->'EntityId' as entityid,
        ...
        _airbyte_data::json->'EntityType' as entitytype,
        ...
        _airbyte_data::json->'NameOfEntity' as nameofentity,
    ...
    FROM
        {{ source(
            'raw_crm',
            '_airbyte_raw_crm_entityassignments'
        ) }}
...
data_type_rename_conversion AS (
    SELECT
        id :: INT AS "crm_entityassignment_id",
        entityid :: INT AS "crm_entity_id",
