...
WITH source AS (
    ...
    SELECT
        ...
        _airbyte_data::json->'TechStackId' as techstackid,
    ...
    FROM
        {{ source(
            'raw_crm',
            '_airbyte_raw_crm_techstacksdeal'
        ) }}
),
data_cleaning AS (
    SELECT
...
data_type_rename_conversion AS (
    SELECT
        id :: INT AS "crm_techstacksdeal_id",
        dealid :: INT AS "crm_deal_id",
        techstackid :: INT AS "crm_techstack_id",
