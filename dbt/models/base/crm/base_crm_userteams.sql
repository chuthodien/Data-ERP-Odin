...
WITH source AS (
    ...
    FROM
        {{ source(
            'raw_crm',
            '_airbyte_raw_crm_userteams'
        ) }}
),
data_cleaning AS (
    SELECT
        {{trim_qoutes_col('id')}},
        {{trim_qoutes_col('teamid')}},
        {{trim_qoutes_col('userid')}},
        {{trim_qoutes_col('tenantid')}},
        {{trim_qoutes_col('isdeleted')}},
        {{trim_qoutes_col('teammember')}},
...
data_type_rename_conversion AS (
    SELECT
        id :: INT AS "crm_userteams_id",
        teamid :: INT AS "crm_team_id",
        userid :: INT AS "crm_user_id",
        teammember :: INT AS "team_size",
