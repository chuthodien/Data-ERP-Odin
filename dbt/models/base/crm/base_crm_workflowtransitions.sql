...
WITH source AS (
    ...
    SELECT
        ...
        _airbyte_data::json->'ToStatus' as tostatus,
        _airbyte_data::json->'IsDeleted' as isdeleted,
        _airbyte_data::json->'FromStatus' as fromstatus,
    ...
    FROM
        {{ source(
            'raw_crm',
            '_airbyte_raw_crm_workflowtransitions'
        ) }}
),
data_cleaning AS (
    SELECT
        ...
        {{trim_qoutes_col('tostatus')}},
        {{trim_qoutes_col('isdeleted')}},
        {{trim_qoutes_col('fromstatus')}},
...
data_type_rename_conversion AS (
    SELECT
        id :: INT AS "crm_workflowtransition_id",
        tostatus :: INT AS "to_status",
        fromstatus :: INT AS "from_status",
        workflowid :: INT AS "workflowid",
